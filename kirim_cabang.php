...
var table_cart_kc = $('#data_cart_kc').DataTable({
					"bPaginate": false,
					"aProcessing": true,
					"aServerSide": true,
...
function data_barang_kc(){
	$.ajax({
			...
			success: function(datas){
					...
					if(datas[0]!=null){
						var hasil = '<select name="kckode" id="kckode" class="form-control" data-provide="typeahead">';
...
function data_cabang(){
	$.ajax({
			...
			success: function(datas){
					if(datas[0]!=null){
						var hasil = '<select name="kccabang" id="kccabang" class="form-control" data-provide="typeahead">';
                ...
                <table width="80%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" class="btn btn-primary" value="Reset" id="kcreset" />
                        </td>
                    </tr>      
                </table>
                </form>
