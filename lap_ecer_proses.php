...
if(isset($_POST['aksi'])){
	if($_POST['aksi']=='data'){
		...
		$sampais = explode("/", escape($_POST['ecsampai']));
		$sampai = $sampais[2].'-'.$sampais[1].'-'.$sampais[0];
		header("location:lap_ecer_excel.php?dari=$dari&sampai=$sampai");
	}
