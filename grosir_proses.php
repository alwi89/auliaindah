...
if(isset($_POST['aksi_grosir'])){
	if($_POST['aksi_grosir']=='tambah'){
		...
		$a = mysql_query("insert into grosir(total, jumlah, no_nota, tgl_keluar, username, kode_sales, dibayar, kekurangan, tgl_tempo, potongan, ket_potongan, id_cabang) values('$total', '0', '$no_nota', '$tgl_keluar', '$username', '$sales', '$dibayar', '$kekurangan', $tgl_tempo, '$potongan', '$ket_potongan', '$id_cabang')");
		if($a){
