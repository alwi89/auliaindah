...
if(isset($_POST['aksi_akun'])){
	if($_POST['aksi_akun']=='edit'){
		...
		$a = mysql_query("update karyawan set username='$username', nama='$nama_karyawan', no_telp='$no_tlp', password='$password' where username='$kode_lama_karyawan'");
		if($a){
