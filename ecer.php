...
var table_cart_ec = $('#data_cart_ec').DataTable({
					"bPaginate": false,
					"aProcessing": true,
					"aServerSide": true,
...
function data_barang_ec(){
	$.ajax({
			...
			success: function(datas){
					...
					if(datas[0]!=null){
						var hasil = '<select name="eckode" id="eckode" class="form-control" data-provide="typeahead">';
                ...
                <table width="80%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" class="btn btn-primary" value="Reset" id="ecreset" />
                        </td>
                    </tr>      
                </table>
                </form>
