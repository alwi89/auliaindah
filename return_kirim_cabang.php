...
var table_cart_rkc = $('#data_cart_rkc').DataTable({
					"bPaginate": false,
					"aProcessing": true,
					"aServerSide": true,
...
function data_barang_rkc(){
	$.ajax({
			...
			success: function(datas){
					...
					if(datas[0]!=null){
						var hasil = '<select name="rkckode" id="rkckode" class="form-control" data-provide="typeahead">';
...
function data_cabang_rkc(){
	$.ajax({
			...
			success: function(datas){
					if(datas[0]!=null){
						var hasil = '<select name="rkccabang" id="rkccabang" class="form-control" data-provide="typeahead">';
        ...
        <section class="content">
             <div id="message_rkc"></div>
              <div style="background:#FFFFFF;padding:15px;">
                ...
                Total : <div id="h_total_rkc">0</div>
                </div>
                <form id="frkc">
