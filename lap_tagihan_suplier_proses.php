...
if(isset($_POST['aksi'])){
	if($_POST['aksi']=='data'){
		...
		$a = mysql_query("select p.kode_suplier, no_nota, nama_suplier, no_tlp, alamat, total, dibayar, kekurangan, tgl_tempo  from suplier m join barang_masuk p on m.kode_suplier=p.kode_suplier where kekurangan<>'0' and tgl_masuk between '$dari' and '$sampai' order by nama_suplier asc, alamat asc");
